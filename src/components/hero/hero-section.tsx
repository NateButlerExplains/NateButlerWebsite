        ...
        <div className="absolute inset-0 flex flex-col justify-end px-6 pt-2 pb-24 z-10">
          ...
          >
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-3 px-8 py-3 rounded-full bg-transparent border border-slate-400 text-slate-100 font-space-grotesk font-semibold uppercase tracking-widest text-xs transition-all duration-200 hover:border-cyan-400 hover:text-cyan-400 active:scale-95"
            >
              <svg
                width="20"
                height="20"
