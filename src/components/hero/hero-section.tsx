    ...
    <section className="relative w-full hero-section overflow-x-hidden md:flex md:items-center md:pt-28 pb-0 md:pb-20 md:min-h-auto">
      ...
      <div className="md:hidden relative w-full h-screen -mt-[48px]">
        ...
        <div className="absolute inset-0 flex flex-col justify-end px-6 pt-2 pb-12 z-10">
          ...
          {/* Featured On Section — Mobile */}
          <motion.div
            className="w-full mt-12 pt-6 border-t border-white/10"
            {...fadeInUp}
          ...
          >
            ...
            {/* Mobile scrolling logos — horizontal scroll */}
            <div className="relative" style={{ maskImage: 'linear-gradient(to right, transparent 0%, black 15%, black 85%, transparent 100%)', overflow: 'visible', paddingTop: '0.75rem' }}>
              <motion.div
